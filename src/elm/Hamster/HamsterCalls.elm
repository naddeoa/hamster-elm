...
getActivities search =
    HamsterRequest Activities.decode ("activities/" ++ search) Activities.encode API.GET Nothing
...
getTags =
    API.HamsterRequest Tags.decode "tags" Tags.encode API.GET Nothing


getTodaysFacts : HamsterRequest Facts
getTodaysFacts =
    API.HamsterRequest Facts.decode "facts/today" Facts.encode API.GET Nothing


stopTracking : HamsterRequest NewEndTime
stopTracking =
    API.HamsterRequest NewEndTime.decode "tracking/stop" NewEndTime.encode API.POST Nothing


createFact : Fact -> HamsterRequest Fact
createFact fact =
    API.HamsterRequest Fact.decode "facts/add" Fact.encode API.POST (Just fact)
